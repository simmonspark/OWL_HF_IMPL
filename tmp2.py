...
if __name__ == "__main__":
    ...
    from models.owl_v1 import OwlViTForObjectDetection as v1
    from models.owl_v2_for_train import OwlViTForObjectDetection as v2# 사용자 정의 모델 로드
    ...
    # 3. 이미지와 탐지할 객체 설정
    image_path = "/home/sien/다운로드/스크린샷 2025-05-08 10-03-36.png"
    objects_to_detect = ["person","man","walking person"]  # 감지할 객체 리스트
