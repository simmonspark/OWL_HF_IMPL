...
class PushPullLoss(torch.nn.Module):
    ...
    def class_loss(self, outputs, target_classes):
        ...
        # pos_loss = torch.nn.functional.binary_cross_entropy(pred_logits, pos_targets.float())
        # neg_loss = torch.nn.functional.binary_cross_entropy(pred_logits, pos_targets.float())
